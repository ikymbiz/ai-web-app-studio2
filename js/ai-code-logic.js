...
(function () {
  const GENERATED_APP_STRUCTURE_INSTRUCTION = [
    '生成するWebアプリは、原則として次のRoot構造を含める: docs/, src/apps/, src/admin/, config/, .github/.',
  ...
  const CODE_ONLY_INSTRUCTION = [
    ...
    'HTML/CSS/JSなど複数ファイルで実装する場合は、説明文を混ぜず、次のJSONだけを出力する: {"entryFile":"src/admin/index.html","files":[{"path":"docs/PRINCIPLE.md","content":"..."},{"path":"docs/DEVELOPMENT_RULES.md","content":"..."},{"path":"docs/SYSTEM_DESIGN.md","content":"..."},{"path":"docs/FAILURE_LOG.md","content":"..."},{"path":"docs/HANDOVER.md","content":"..."},{"path":"src/admin/index.html","content":"..."},{"path":"src/admin/styles.css","content":"..."},{"path":"src/admin/script.js","content":"..."},{"path":"src/apps/README.md","content":"..."},{"path":"config/README.md","content":"..."},{"path":".github/README.md","content":"..."}]}',
